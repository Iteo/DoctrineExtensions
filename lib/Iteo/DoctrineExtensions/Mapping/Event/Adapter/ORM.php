...
namespace Iteo\DoctrineExtensions\Mapping\Event\Adapter;

use Iteo\DoctrineExtensions\Mapping\Event\AdapterInterface;
use Iteo\DoctrineExtensions\Exception\RuntimeException;
